  ...
  return (
    <div className={containerRoot}>
      ...
      <Text className={text}>
        ...
        <br />
        <br />
        1. 프로덕트를 만들기 위해 팀원들과 함께 하는 소통과 의사결정의 과정이
        ...
        <br />
        <br />
        2. Frontend Engineering은 다음과 같은 작업을 수행합니다. 도메인을
        ...
        <br />
        <br />
        3. IT 개발자들 간의 문화에 자부심을 가집니다. 다른 집단보다 서로에게
